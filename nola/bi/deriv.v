...
Section deriv.
  ...
  Definition der : JUDG → PROP := psg (OT:=JUDG -p> PROP) dsem.
  ...
  Proof. move: J. exact (psg_post (OT:=JUDG -p> PROP)). Qed.
End deriv.
